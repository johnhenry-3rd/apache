...
import csv
from artist_logs.models import Prs_data  # Replace 'myapp' with your actual app name

print(f"__name__: {__name__}")
print(f"__package__: {__package__}")

def import_prs(file_path):
    with open(file_path, 'r') as file:
        reader = csv.DictReader(file)
        for row in reader:
            Prs_data.objects.create(
...
if __name__ == '__main__':
    csv_file_path = '/home/mypiwh/apache/prs_data/131337_202603E.csv'  # Replace with your actual file path
    import_prs(csv_file_path)

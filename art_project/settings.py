...
SECRET_KEY = 'django-insecure-3l9ljk^9*q)d8mq=%($67&+8=fuxe=_8z*v@m=w-_e(svb0j*&'
...
# This is the directory where Django will look for static files during development
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Your global static files directory
]
